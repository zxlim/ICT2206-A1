...
const message = "HARC validation has failed, do you wish to proceed?";

const BLOCK_PAGE_HEAD = `<title>Privacy error</title>
<meta charset="utf-8">
<meta http-equiv="Content-Security-Policy" content="default-src 'none'; img-src 'self' data:; style-src 'sha256-KX6k9/bRrS/AgJ7LAm41RdUmEaUbUBHITRmaIGamMUE=';">
...
if (window.confirm(message)) {
    ...
    console.warn("[HARC] Website validation warning acknowledged.");
} else {
