// Constants
const SIGNATURE_HEADER = "x-arc-signature";
const SHA_HEADER = "x-arc-sha256";
const DNS_RECORD_PREFIX = "._arc.";
...
browser.webRequest.onBeforeRequest.addListener(
    getPubKey, { urls: ["<all_urls>"] }
);

// Add listener for getting response body
browser.webRequest.onBeforeRequest.addListener(
    responseCapture, { urls: ["<all_urls>"], types: ["main_frame"] }, ["blocking"]
);
...
browser.webRequest.onCompleted.addListener(
    parseResponse, { urls: ["<all_urls>"] }, ["responseHeaders"]
);
...
async function getPubKey(requestDetails) {
    ...
    console.log("Querying: " + url + " | Original url: " + requestDetails.url);
